...
/*
((\d{3}) ?): busca un paréntesis que contiene exactamente 3 dígitos (\d{3}), seguido de un espacio opcional ( ?)
|: es un operador OR que indica que se puede buscar una de las dos opciones siguientes
(\d{3}-): busca exactamente 3 dígitos (\d{3}) seguidos de un guión (-)
?: hace que la búsqueda anterior sea opcional
\d{3}-\d{4}: busca exactamente 3 dígitos (\d{3}) seguidos de un guión (-) y luego exactamente 4 dígitos (\d{4})
*/
